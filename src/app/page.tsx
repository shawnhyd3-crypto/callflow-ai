          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                price: '$149',
                minutes: '500 min/mo',
                features: ['Up to 3 AI agents', 'Full analytics', 'Call transcripts', 'Appointment booking', 'Priority support'],
                highlight: true,
                cta: 'Start Free Trial',
              },
              {
                ...
                features: ['Up to 10 agents', 'Custom integrations', 'Analytics suite', 'Dedicated manager', '24/7 phone support'],
                highlight: false,
                cta: 'Contact Sales',
              },
            ].map((plan, index) => (
